  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      if (startPlacemark != null && destinationPlacemark != null) {
        ...
        polylineCoordinates.add(LatLng(startCoordinates.latitude, startCoordinates.longitude));
        polylineCoordinates.add(LatLng(destinationCoordinates.latitude, destinationCoordinates.longitude));
